...
export const projects = [
  // ─── M1 — GloShip (하계중학교 · Indonesia) ─────────────────────────────────
  {
    ...
    members: ["Wonjin Choi", "Gyudo Park", "Abravia Ramadhani", "Shabri Sinegar"],
    teacher: "Woohong Seol · MokletHebatLab-M Arifin",
    deployUrl: "",
  ...
  // ─── H1 — SnapCare (충남삼성고등학교 · Moldova) ────────────────────────────
  {
    ...
    members: ["Yunsu Nam", "Dohun Kim", "Stanchevici Daniel", "Cristian Rudico"],
  ...
  // ─── H2 — ReNew (대전대신고등학교 · Rwanda) ────────────────────────────────
  {
    ...
    members: ["Ryan Ahn Song", "Sunmin Kim", "Chaste Ganza Muganamfura", "Bruce Nibeza"],
    teacher: "Jungeun Park · Projecte Habyarimana",
    deployUrl: "",
  ...
  // ─── H3 — Daily Cog (부산기계공업고등학교 · Uzbekistan) ────────────────────
  {
    ...
    members: ["Suhyeon Wang", "Jiho Park", "Aziza Abdiganieva", "Parvina Bakhodirova"],
